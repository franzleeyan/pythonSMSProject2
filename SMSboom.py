...
APIList = [
    ...
    ['https://www.taopuwang.com/ajax/GetPhonCode.ashx',60,'淘铺王','POST',{'tel': phone,'action': 'Login'},""],

    ['https://iask.sina.com.cn/cas-api/sendSms',60,'爱问知识人','POST',{'businessCode': '4','nationCode': '86','mobile': phone,'terminal': 'PC','businessSys': 'iask',},''],
